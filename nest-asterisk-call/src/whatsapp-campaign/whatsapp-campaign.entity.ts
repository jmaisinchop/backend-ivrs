...
export class WhatsappCampaign {
    ...
    // ✅ Todas las campañas ahora empiezan PAUSADAS por defecto
    @Column({ default: 'PAUSED' })
    status: string; // Estados: PAUSED, RUNNING, COMPLETED, CANCELLED

    // ✅ Nuevos campos para registrar las horas reales
