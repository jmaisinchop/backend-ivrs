...
// Es buena idea excluir User para no registrar cada actualización del token.
// Si necesitas auditar cambios en User (ej. cambio de rol), puedes quitarlo de esta lista.
